...
# data from VL
# =============================================================================
path = r'C:\Users\gavgous\OneDrive - Zanders-BV\Desktop\Lombard Lending\DATA'
data = pd.read_excel(path+'\\Lombard_Project_datarequirements.xlsx',
                     '10071687 BN')
data = pd.DataFrame(data.iloc[6:,1: ].values, columns = data.iloc[3, 1:], index = data.iloc[6:,0]).dropna()
data.index = pd.DatetimeIndex(data.index)
data = data.iloc[::-1]
...
# =============================================================================
# simuls = dcc.DCC_GARCH_simulation()
