...
for t in tqdm(range(len(data))):
    gb = deployment_GB_1d(save = None, returns_file=data[t])
    
    rnn = deployment_RNN_1d(lstm = False, save = None, returns_file=data[t])
    
    lstm = deployment_RNN_1d(lstm = True, save = None, returns_file=data[t])
    
    fnn = deployment_DNN_1d(save = None, returns_file=data[t])
